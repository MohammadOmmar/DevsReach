...
// Demo account details - same for all roles
const demoPassword = 'demo123';
const passwordHash = bcrypt.hashSync(demoPassword, 10);
const demoEmail = 'omarmohd742@gmail.com';

// Clear existing users and demo data
db.users = [];
db.schools = [];
db.drivers = [];
db.vehicles = [];
...
console.log('');
console.log('📋 Demo Account Details (Same for all roles):');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
console.log('  1. Parent  - M Omar (Parent)');
console.log('  2. School  - M Omar (School Admin)');
console.log('  3. Driver  - M Omar (Driver)');
console.log('  4. RTO     - M Omar (RTO Admin)');
console.log('');
console.log('💡 Use the role selector on the login page to switch between accounts!');
console.log('   All accounts use the same email and password.');